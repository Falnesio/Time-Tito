...
**Biforcations:          
**The changes in the amount of periods as we change the parameter **r**. There is a change in the topology of the attractor, it is a qualitative change. The fixed point does not move, it vanishes.
